...
namespace Book.DA.SQLServer
{
    ...
    public partial class BusinessHoursAccessor : EntityAccessor, IBusinessHoursAccessor
    {
        ...
        #region IBusinessHoursAccessor 成员


        public IList<Book.Model.BusinessHours> SelectIdAndName()
        {
            return sqlmapper.QueryForList<Model.BusinessHours>("BusinessHours.SelectIdAndName",null);
        }
