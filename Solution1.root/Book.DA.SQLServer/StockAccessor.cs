...
namespace Book.DA.SQLServer
{
    ...
    public partial class StockAccessor : EntityAccessor, IStockAccessor
    {
        ...
        public IList<Model.StockSeach> SelectOutAndInDepot(DateTime startDate, DateTime endDate, string startProductCategory, string endProductCategory)
        {
            ...
            StringBuilder sb = new StringBuilder("select a.InvoiceType,a.InvoiceNo,a.XOId,xo.CustomerInvoiceXOId as CusXOId,a.InvoiceDate,a.ProductId,a.PId,a.ProductName,a.InvoiceQuantity,dp.Id as PositionName,pc1.ProductCategoryName as ProductCategoryName1,pc2.ProductCategoryName as ProductCategoryName2,pc3.ProductCategoryName as ProductCategoryName3 from ( ");
