...
namespace Book.DA
{
    public interface IMiscDataAccessor : IAccessor
    {
        ...
        System.Data.DataTable SelectByCondition(string queryId, string depotId, string depotPositionId, string productCategoryId, string ProductNameOrId, string proname1, string proname2, string protypeid1, string protypeid2, bool check);
