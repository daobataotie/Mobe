...
namespace Book.DA.SQLServer
{
    ...
    public partial class ClockDataAccessor : EntityAccessor, IClockDataAccessor
    {
        ...
        {
            SqlConnection con = new SqlConnection(sqlmapper.DataSource.ConnectionString);
            string sqlStr = "select * from ClockData where  EmployeeId='"+employeeId+"' and  Clocktime='"+clockDate.ToString ("yyyy-MM-dd HH:mm:ss")+"'";
        ...
        {
            return sqlmapper.QueryForList<Book.Model.ClockData>("ClockData.select_ ClockTopTreeMonth",null);
        }
    }
}
