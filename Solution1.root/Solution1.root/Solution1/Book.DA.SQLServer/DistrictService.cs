...
namespace Book.DA.SQLServer
{
    ...
    {
        public static IList<District> GetAllDistrict(string sql, SqlParameter[] paras)
        {
            ...
            if (table != null)
            {
                if (table.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow row in table.Rows)
                    {
                        ...
                        if (CityService.GetCityByID(district.CityId)!=null)
                        {
                            district.City = CityService.GetCityByID(district.CityId)[0];
                        }
                        list.Add(district);
                    }
                }
