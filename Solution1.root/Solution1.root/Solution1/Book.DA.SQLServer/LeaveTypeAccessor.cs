...
namespace Book.DA.SQLServer
{
    ...
    public partial class LeaveTypeAccessor : EntityAccessor, ILeaveTypeAccessor
    {
        ...
        public void SaveLeaveTypeInfo(System.Data.DataTable table)
        {
            ...
            adapter.UpdateCommand = new SqlCommand("update LeaveType set UpdateTime=getdate(),LeaveTypeName=@LeaveTypeName,PayRate=@PayRate,IsCountToPunish=@IsCountToPunish  where LeaveTypeId=@LeaveTypeId", con);
            ...
            adapter.InsertCommand = new SqlCommand("insert into LeaveType(LeaveTypeId,InsertTime,LeaveTypeName,PayRate,IsCountToPunish) values(newid(),getdate(),@LeaveTypeName,@PayRate,@IsCountToPunish)", con);
            SqlParameter[] sqlParameters = new SqlParameter[] { new SqlParameter("@LeaveTypeName", SqlDbType.VarChar, 50, "LeaveTypeName"), new SqlParameter("@PayRate", SqlDbType.Float, 0, "PayRate"), new SqlParameter("@IsCountToPunish", SqlDbType.Bit, 0, "IsCountToPunish") };
