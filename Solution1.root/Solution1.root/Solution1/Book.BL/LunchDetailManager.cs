...
namespace Book.BL
{
    ...
    public partial class LunchDetailManager
    {
        ...
        {
            return accessor.GetEmployeeInfo(year, month);
        }
        ...
        //根据员工和日期查询
        public IList<Model.LunchDetail> selectByempAndDate(Model.Employee emp, int year, int month)
        {
            return accessor.selectByempAndDate(emp,year,month);
        }
    }
}
