...
namespace Book.BL
{
    ...
    public partial class ProductManager : BaseManager
    {
        ...
        private string TiGuiExists(Model.Product product)
        {
        ...
        public void Insert(Model.Product product)
        {
            ...
            {
                //throw new Helper.InvalidValueException(Model.Product.PRO_Id);
                product.Id = TiGuiExists(product);
            }
        ...
        public void Update(Model.Product product)
        {
            try
            {
                ...
                if ((product.IsProcee == null || product.IsProcee == false) && product.ProductProcess.Count > 0) product.ProductDescription = accessor.Get(product.ProductId).ProductDescription;
