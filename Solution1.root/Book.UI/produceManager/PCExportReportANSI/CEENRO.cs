...
namespace Book.UI.produceManager.PCExportReportANSI
{
    public partial class CEENRO : DevExpress.XtraReports.UI.XtraReport
    {
            ...
            : this()
        {
            ...
            //this.LbTestPackaging.Text = (_PCExportReportANSI.ShouCeShu11.HasValue ? _PCExportReportANSI.ShouCeShu11.ToString() : "0") + "PCS";
            //this.LbTestPackaging.Text += "/" + this.LbTestPackaging.Text;
            ...
            //this.LbJudgePackaging.Text = (_PCExportReportANSI.PanDing11.HasValue ? _PCExportReportANSI.PanDing11.ToString() : "0") + "PASS";
