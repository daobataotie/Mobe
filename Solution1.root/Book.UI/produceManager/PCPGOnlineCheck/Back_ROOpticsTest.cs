...
{
    public partial class Back_ROOpticsTest : DevExpress.XtraReports.UI.XtraReport
    {
        public Back_ROOpticsTest()
        {
            InitializeComponent();
        }
        public Back_ROOpticsTest(Model.OpticsTest opticsTest)
            : this()
        {
            if (opticsTest == null)
                return;
