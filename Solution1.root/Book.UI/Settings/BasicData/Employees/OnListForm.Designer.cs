namespace Book.UI.Settings.BasicData.Employees
{
    partial class OnListForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            new DevExpress.XtraEditors.Controls.LookUpColumnInfo("DepartmentName", "部門名稱", 10),
            new DevExpress.XtraEditors.Controls.LookUpColumnInfo("DepartmentId", "編號", 20, DevExpress.Utils.FormatType.None, "", false, DevExpress.Utils.HorzAlignment.Default, DevExpress.Data.ColumnSortOrder.None)});
            this.repositoryItemLookUpEdit1.DisplayMember = "DepartmentName";
            this.repositoryItemLookUpEdit1.DropDownRows = 10;
            this.repositoryItemLookUpEdit1.Mask.AutoComplete = ((DevExpress.XtraEditors.Mask.AutoCompleteType)(resources.GetObject("repositoryItemLookUpEdit1.Mask.AutoComplete")));
            this.repositoryItemLookUpEdit1.Mask.BeepOnError = ((bool)(resources.GetObject("repositoryItemLookUpEdit1.Mask.BeepOnError")));
            this.repositoryItemLookUpEdit1.Mask.EditMask = resources.GetString("repositoryItemLookUpEdit1.Mask.EditMask");
            this.repositoryItemLookUpEdit1.Mask.IgnoreMaskBlank = ((bool)(resources.GetObject("repositoryItemLookUpEdit1.Mask.IgnoreMaskBlank")));
            this.repositoryItemLookUpEdit1.Mask.MaskType = ((DevExpress.XtraEditors.Mask.MaskType)(resources.GetObject("repositoryItemLookUpEdit1.Mask.MaskType")));
            this.repositoryItemLookUpEdit1.Mask.PlaceHolder = ((char)(resources.GetObject("repositoryItemLookUpEdit1.Mask.PlaceHolder")));
            this.repositoryItemLookUpEdit1.Mask.SaveLiteral = ((bool)(resources.GetObject("repositoryItemLookUpEdit1.Mask.SaveLiteral")));
            this.repositoryItemLookUpEdit1.Mask.ShowPlaceHolders = ((bool)(resources.GetObject("repositoryItemLookUpEdit1.Mask.ShowPlaceHolders")));
            this.repositoryItemLookUpEdit1.Mask.UseMaskAsDisplayFormat = ((bool)(resources.GetObject("repositoryItemLookUpEdit1.Mask.UseMaskAsDisplayFormat")));
