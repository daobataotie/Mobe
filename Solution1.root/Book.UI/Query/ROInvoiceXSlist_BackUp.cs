...
{
    public partial class ROInvoiceXSlist_BackUp : DevExpress.XtraReports.UI.XtraReport
    {
        protected BL.InvoiceXSDetailManager detailManager = new Book.BL.InvoiceXSDetailManager();

        public ROInvoiceXSlist_BackUp()
        {
            InitializeComponent();
        }

        public ROInvoiceXSlist_BackUp(ConditionX condition)
            : this()
        {
