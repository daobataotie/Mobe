...
// 编 码 人:  够波涛             完成时间:2009-6-23
// 修改原因：
// 修 改 人:                          修改时间:
// 修改原因：
// 修 改 人:                          修改时间:
//----------------------------------------------------------------*/
    public partial class Q39 : BaseReport
    {
        private BL.InvoiceDetail01Manager detailManager = new Book.BL.InvoiceDetail01Manager();


        //构造，初始化
        public Q39(ConditionF conditioon)
        {
            InitializeComponent();

            this.xrLabelReportName.Text = Properties.Resources.YFZKTJB;
            ...
            System.Collections.Generic.IList<Model.InvoiceDetail01> list = this.detailManager.Select1(conditioon.StartDate, conditioon.EndDate, conditioon.StartId, conditioon.EndId, Helper.CompanyKind.Supplier);
