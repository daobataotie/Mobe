...
//
// file name：InvoiceCOManager.autogenerated.cs
// author: peidun
...
namespace Book.BL
{
    public partial class InvoiceCOManager
    {
		///<summary>
		/// Data accessor of dbo.InvoiceCO
		///</summary>
		private static readonly DA.IInvoiceCOAccessor accessor = (DA.IInvoiceCOAccessor)Accessors.Get("InvoiceCOAccessor");
