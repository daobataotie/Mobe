...
//
// file name：PCOpticsCheckManager.autogenerated.cs
// author: mayanjun
...
namespace Book.BL
{
    public partial class PCOpticsCheckManager
    {
		///<summary>
		/// Data accessor of dbo.PCOpticsCheck
		///</summary>
		private static readonly DA.IPCOpticsCheckAccessor accessor = (DA.IPCOpticsCheckAccessor)Accessors.Get("PCOpticsCheckAccessor");
		
		/// <summary>
		/// Select by primary key.
		/// </summary>		
		public Model.PCOpticsCheck Get(string pCFogCheckId)
		{
