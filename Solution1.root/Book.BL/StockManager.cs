...
namespace Book.BL
{
    ...
    public partial class StockManager : BaseManager
    {
        ...
        public void Insert(IList<Model.Stock> list)
        {
            foreach (Model.Stock item in list)
            {
                ...
                if (stock != null)
                {
                    ...
                    if (item.Stock0Date != null)
                        stock.Stock0Date = item.Stock0Date;
                    this.Update(stock);
        ...
        {
            return accessor.Get0DateByProduct(productid);
        }
        ...
        {
            return accessor.SelectStockQuantity1(productId, depotpositionId);
        }
